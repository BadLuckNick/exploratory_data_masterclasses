...
## The RStudio IDE Windows. 
 ...
 ``` 
 ## **EXERCISE 1** Opening new script files
...
## **EXERCISE 4** Appearance and general settings
...
## **EXERCISE 5**
 ...
 1. Commit you changes in the `Git` panel of the `Development` window
     ...
     devtools::devtools::install_github("uashogeschoolutrecht/gitr")
     gitr::set_git_user("<insert e-mail>", "<insert username")
